...
//|         ahead of the beam, avoiding tearing without a second framebuffer. Bounded by a short
//|         timeout, so it is safe even if no DVI signal is active. No-op on the RP2040 PIO-DVI path."""
//|         ...
